...
regions = ['10S', '10T', '11R', '12R', '16T', '17R', 
           '17T', '18S',
...
for region in regions:    
    ...
    command = "python eval_landmarks.py --model_path ../sim/models/" + region + ".pt --im_path datasets/" + region + "/images --lab_path datasets/" + region + "/labels --output_path " + region + "_xyerr.npy --calculate_xy_err --save_err"
